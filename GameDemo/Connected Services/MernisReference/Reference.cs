...
namespace MernisReference
{
    ...
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<MernisReference.KPSPublicSoap>, MernisReference.KPSPublicSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<MernisReference.TCKimlikNoDogrulaResponse> MernisReference.KPSPublicSoap.TCKimlikNoDogrulaAsync(MernisReference.TCKimlikNoDogrulaRequest request)
        {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<MernisReference.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili)
        {
            MernisReference.TCKimlikNoDogrulaRequest inValue = new MernisReference.TCKimlikNoDogrulaRequest();
            inValue.Body = new MernisReference.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((MernisReference.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
        ...
        internal bool TCKimlikNoDogrula(long nationalityId, string v1, string v2, int year)
        {
